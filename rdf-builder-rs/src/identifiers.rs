...
///
/// ```
/// # use rdf_builder_rs::identifiers::{GroupIDError, GroupID, GroupIDErrorKind};
...
///
/// ```
/// # use rdf_builder_rs::identifiers::{GroupIDError, GroupID};
...
///
/// ```
/// use rdf_builder_rs::identifiers::{GroupIDChanger,GroupIDErrorKind};
///
/// #[derive(Debug, PartialEq, Eq, Clone)]
/// struct ChildStruct {
///     name: String
