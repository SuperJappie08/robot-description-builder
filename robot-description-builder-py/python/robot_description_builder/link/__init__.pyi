...
# Need to use typing.List instead `|` because `|` (Supported since Python 3.10)
...
class LinkBuilder:
    ...
    def add_visual(self, visual_builder: VisualBuilder): ...
    def add_collider(self, collision_builder: CollisionBuilder): ...
    def add_inertial(self, inertial: Inertial): ...
